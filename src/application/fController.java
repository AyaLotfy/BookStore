...
public class fController implements Initializable {
	...
	private TableColumn<GameOfThronesCharacter2, String>  address;
	private TableColumn<GameOfThronesCharacter2, String>  sales;
	...
	private ObservableList<GameOfThronesCharacter2> getCharacters() {
		...
		for (int i = 0; i < data3.length; i++) {
			...
			GameOfThronesCharacter2 g = new GameOfThronesCharacter2(data3[i][0], data3[i][1], data3[i][2], data3[i][3], data3[i][4],
					data3[i][5], data3[i][6]);
			characters.add(g);
